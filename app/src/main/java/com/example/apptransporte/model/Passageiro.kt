...
class Passageiro(val id: Int=0, val cpf: String="", val nome: String="", val email: String="", val telefone: String="", val endereco: String="", val idUniversidadeFK: Int=0, val senha: String="") {
